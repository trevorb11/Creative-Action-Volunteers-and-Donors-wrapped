      ...
      <div className="flex flex-col items-center space-y-6">
        ...
        >
          ...
          <div className="relative h-40 w-full flex justify-center">
            {/* Green circle at top */}
            <motion.div 
              className="absolute top-1 left-[30%] transform -translate-x-1/2 h-6 w-6 rounded-full border-2 border-[#BAD9A3] bg-white flex items-center justify-center"
              animate={{ 
            ...
            <motion.div 
              className="absolute top-12 left-[30%] transform -translate-x-1/2 h-2 w-28 bg-[#F08445] rounded-md"
              animate={{ 
                rotate: [-2, 2, -1, 2, -2] 
              }}
              transition={{ 
