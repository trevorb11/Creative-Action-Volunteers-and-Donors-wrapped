    ...
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-b from-green-50 to-green-100 p-4">
      <div className="w-full max-w-lg">
        <Card className="border-none shadow-lg">
          <CardHeader className="text-center bg-[#8dc53e] text-white rounded-t-lg pb-6">
            <motion.div
          ...
          <CardContent className="pt-8 pb-8">
            ...
            >
              <div className="w-20 h-20 rounded-full bg-green-50 flex items-center justify-center">
                <Gift className="h-10 w-10 text-[#8dc53e]" />
              </div>
              ...
              <div className="text-center max-w-md">
                ...
                <p className="text-gray-700 mb-6">
                  Let's explore the incredible impact your donation is making in our community!
                </p>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full mb-6">
                <div className="bg-white p-4 rounded-lg shadow text-center">
                  <HeartHandshake className="h-8 w-8 text-[#8dc53e] mx-auto mb-2" />
                  <p className="text-sm text-gray-600">People Helped</p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow text-center">
                  <LineChart className="h-8 w-8 text-[#8dc53e] mx-auto mb-2" />
                  <p className="text-sm text-gray-600">Financial Impact</p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow text-center">
                  <Gift className="h-8 w-8 text-[#8dc53e] mx-auto mb-2" />
